...
- Two stationary holds on a Pixel 8 Pro are recorded in `gps-reception.md`: indoors 91/137/197 m and at a window border 111/239/355 m, with **no fix inside the 20 m gate in either** and nothing billed. The conservative contract is confirmed on hardware; the open question it raises is step 8.3's provisional time accrual during an outage.
