...
| Room schema | `app/schemas/` | Versioned exported schemas, currently versions 1, 2 and 3. Keep them updated with intentional schema changes, and add a migration test for every new version. |
